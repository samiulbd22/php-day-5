                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="action.php" method="POST">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Odd or even</label>
                                <div class="col-md-9">
                                    <label><input type="radio"  name="odd_even" value="odd" class="mr-1"/>Odd</label>
                                    <label><input type="radio"  name="odd_even" value="even" class="mr-1"/>Even</label>
                                </div>
                            </div>
                            <div class="form-group row">
